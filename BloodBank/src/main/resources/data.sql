...
insert into scheduled_appointment (appointment_id, user_id, passed, canceled) values (2, 1, false, true);
insert into appointment (start, duration, available, blood_center_id, medical_staff_id) values ('2022-12-23 21:58:58.508-07', 1, true, 1, 2);
commit;
