...
import com.bloodbank.BloodBank.security.auth.RestAuthenticationEntryPoint;
import com.bloodbank.BloodBank.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/auth/**").permitAll()		// /auth/**
                ...
                .antMatchers("/api/bloodCenters/all").permitAll()
